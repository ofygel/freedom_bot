...
export const copy = {
  ...
  orderDriverVerificationRequired:
    '🚫 Чтобы брать заказы такси, завершите проверку документов водителя через меню.',
  orderCourierVerificationRequired:
    '🚫 Для выполнения заказов подтвердите документы курьера или пройдите проверку водителя.',
